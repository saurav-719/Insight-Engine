        ...
        with st.spinner("Analyzing your data..."):
            try:
                with st.chat_message("assistant"):
                    ...
                    for text in stream_insights(api_key="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", prompt=prompt, max_tokens=length_map[response_length]):
                        full_response += text
